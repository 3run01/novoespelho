<div>
<nav class="fixed top-0 left-0 right-0 h-20 bg-white border-b border-gray-200 z-50 mb-6">
    <div class="px-6 h-full flex items-center">
        <img src="{{ asset('logo.png') }}" alt="MP Logo" class="w-12 h-12 flex-shrink-0">
...
<aside class="fixed left-0 top-20 bottom-0 w-64 bg-white shadow-lg border-r border-gray-200 z-50">
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <!-- Gestão Espelho -->
            <a href="{{ route('hello') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('hello') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
