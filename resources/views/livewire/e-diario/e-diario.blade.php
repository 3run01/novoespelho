                    ...
                    <form wire:submit.prevent="gerarPortaria" class="mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select wire:model.defer="assunto" class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('assunto') border-red-300 @enderror">
                                    <option value="">Selecione</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea rows="5" wire:model.defer="descricao" class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('descricao') border-red-300 @enderror" placeholder="Descrição detalhada"></textarea>
                                @error('descricao')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
