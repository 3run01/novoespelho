                                                                    ...
                                                                    @foreach ($evento->promotores as $promotor)
                                                                        <div
                                                                            ...
                                                                            <div class="flex items-center gap-2">
                                                                                ...
                                                                                <span
                                                                                    class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $promotor->pivot->tipo === 'titular' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }}">
                                                    ...
                                                    <td class="px-6 py-6 align-top">
                                                        <div class="space-y-3">
                                                            <div class="text-sm text-gray-600">
                                                                ...
                                                                @else
                                                                    <span class="text-gray-500 italic">Não
                                                                        definido</span>
                                                                @endif
                                                            </div>
                                                                    ...
                                                                    <div class="space-y-1">
                                                                        @foreach ($evento->promotores as $promotor)
                                                                            <div
                                                                                ...
                                                                                @else
                                                                                    <span
                                                                                        class="text-gray-500 italic">Período
                                                                                        não definido</span>
                                                                                @endif
                                                                            </div>
                                                                        @endforeach
