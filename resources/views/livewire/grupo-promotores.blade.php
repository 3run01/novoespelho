<div class="ml-44 mt-24 w-full max-w-7xl p-4 sm:p-6 bg-white rounded-lg shadow-sm">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Gerencie os grupos de promotorias e suas competências</p>
        </div>
        <button 
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-600 mt-1">{{ $grupo->competencia }}</div>
                            ...
                            <div class="flex items-center space-x-2">
                                <button 
                                    wire:click="abrirModalEditar({{ $grupo->id }})"
            ...
            <nav role="navigation" aria-label="Navegação de Páginas" class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500">
                        Mostrando <span class="font-medium text-gray-700">{{ $grupos->firstItem() }}</span> até <span class="font-medium text-gray-700">{{ $grupos->lastItem() }}</span> de <span class="font-medium text-gray-700">{{ $grupos->total() }}</span> resultados
                    </p>
                </div>
                <div>
                    <span class="relative z-0 inline-flex rounded-lg">
                        ...
                        @else
                            <a href="{{ $grupos->previousPageUrl() }}" class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-50 hover:text-gray-400">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" /></svg>
                            </a>
                        @endif
                        ...
                        @if ($grupos->hasMorePages())
                            <a href="{{ $grupos->nextPageUrl() }}" class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-200 rounded-r-lg hover:bg-gray-50 hover:text-gray-400">
                                ...
                                <form wire:submit.prevent="salvar">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea 
                                            ...
                                            id="competencia"
                                            rows="2"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('competencia') border-red-300 @enderror"
                                            placeholder="Ex: 4ª,5ª,6ª Cíveis e de Fazenda Pública"
                                        ></textarea>
                                        @error('competencia')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <!-- Município -->
                                    <div class="mb-4">
                                        <label for="municipios_id" class="block text-sm font-medium text-gray-700">Município</label>
                                        <select 
                                            wire:model="municipios_id"
                                            id="municipios_id"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('municipios_id') border-red-300 @enderror"
                                        >
