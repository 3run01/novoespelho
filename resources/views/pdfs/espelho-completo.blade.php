                                            ...
                                            @if ($indexEvento === 0)
                                                <td rowspan="{{ $eventosCount }}">
                                                    ...
                                                    @if ($promotoria->competencia)
                                                        <div class="promotoria-competencia">{{ $promotoria->competencia }}</div>
                                                    @endif
                                                </td>
                                            @endif
                                                        ...
                                                        @php
                                                            ...
                                                            if ($promotoria->promotorTitular->cargos) {
                                                                if (is_array($promotoria->promotorTitular->cargos)) {
                                                                    ...
                                                                    $cargosLista = json_decode($promotoria->promotorTitular->cargos, true) ?? [];
                                                                }
                                                            }
                                                    ...
                                                    @else
                                                        <div class="vacante">
                                                            @if ($promotoria->vacancia_data_inicio)
                                                                Vacante a partir de <span class="data-info">{{ \Carbon\Carbon::parse($promotoria->vacancia_data_inicio)->format('d/m/Y') }}</span>
                                                            @else
                                                                Promotoria Vacante
                                                            @endif
                                                        </div>
