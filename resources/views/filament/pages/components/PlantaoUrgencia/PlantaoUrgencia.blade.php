                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div class="grid grid-cols-2 gap-2 lg:col-span-1">
                            <div>
                                ...
                                <input type="date" wire:model="plantao_periodo_inicio" required class="w-full dark:bg-gray-700 rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="plantao_periodo_fim" required class="w-full rounded-md dark:bg-gray-700 border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
